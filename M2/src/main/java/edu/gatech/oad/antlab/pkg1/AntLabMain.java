 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Caroline Kish");
		  toPrint += p1.toString("ckish3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Rahul Viraj Brahmal");
		  toPrint += p2.toString("rbrahmal3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("David Wang");
		  toPrint += p3.toString("dwang388");
      //Person4 replace P4 with your name
      //and gburdell4 with your gt id
      Person4 p4 = new Person4("Georgianna Lin");
      toPrint += p4.toString("glin39");
      //Person5 replace P4 with your name
      //and gburdell5 with your gt id
      Person5 p5 = new Person5("Kipp Morris");
      toPrint += p5.toString("kmorris9");
     ...
     * @param args the default argument for main method
     * in java
     */
